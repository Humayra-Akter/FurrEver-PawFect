    ...
    <div className="mt-20">
      ...
      <div className="grid lg:grid-cols-2 gap-8 p-8">
        ...
        >
          ...
          <p className="text-sm font-semibold text-justify text-gray-400">
          ...
          <h2 className="text-xl font-bold text-orange-300 my-4">
            Global & Local Impact
          </h2>
          <p className="text-sm font-semibold text-gray-400 text-justify">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          ...
          >
            <h2 className="text-xl text-center font-bold text-orange-300 mb-4">
          ...
          <div
            ...
            className="bg-accent rounded-lg p-6 hover:scale-105 hover:bg-secondary hover:shadow-2xl"
          >
            <h2 className="text-xl font-bold text-orange-300 text-center mb-4">
              Our Vision
            </h2>
            <p className="text-sm font-semibold text-gray-400 text-justify">
