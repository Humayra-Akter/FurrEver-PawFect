  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex flex-col items-center justify-center">
        <h1 className="w-full h-full font-extrabold text-left text-5xl font-mono text-secondary pl-4 pt-7">
          Dashboard
        </h1>
        <Outlet />
        <label
        ...
        <ul className="menu p-4 w-52 h-full bg-primary text-base-content">
          ...
          {/* <li>
            <Link
              ...
              className="w-full uppercase h-full font-bold text-center text-sm text-secondary font mono "
            >
              👉 health record
            </Link>
          </li> */}
