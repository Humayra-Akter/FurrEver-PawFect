...
const CustomerPrice = () => {
  return (
    <div
      className="mx-auto mt-10 p-6 shadow-md rounded-lg"
      style={{
        fontFamily: "'Concert One', cursive",
      }}
    >
      <h1 className="text-2xl    font-bold text-secondary mb-4">Our Pricing</h1>
      <section className="mb-10">
        <h2 className="   text-secondary font-semibold mb-4">Adoption Fees</h2>
